...
COMPOSE_URL="https://raw.githubusercontent.com/dkbhadeshiya/atproto-pds/main/compose.yaml"

# The pdsadmin script.
PDSADMIN_URL="https://raw.githubusercontent.com/dkbhadeshiya/atproto-pds/main/pdsadmin.sh"
